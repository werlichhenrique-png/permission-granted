...
export const translations = {
  pt: {
    ...
    about: {
      ...
      lines: [
        'Já adiei terminar um relacionamento. Fechar uma empresa. Pedir demissão.',
        'Tirar um mês sabático.',
        'Em todos esses casos, eu já sabia a resposta.',
        'Conversei com amigos. Com terapeutas. Com IAs.',
        'Toda vez cheguei à mesma conclusão.',
        'O que faltava não era clareza — era permissão.',
        'Permission Granted existe para dar esse empurrão.',
      ],
  ...
  en: {
    ...
    about: {
      ...
      lines: [
        "I've put off ending a relationship. Closing a company. Quitting a job.",
        'Taking a sabbatical.',
        'In every single case, I already knew the answer.',
        'I talked to friends. To therapists. To AIs.',
        'Every time, I reached the same conclusion.',
        "What was missing wasn't clarity — it was permission.",
